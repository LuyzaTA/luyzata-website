(function () {
  ...
  var T = {
    en: {
      ...
      'proj.ai.label':     'AI Ethics · Content',
      'proj.ai.link':      'Instagram ↗',
      'proj.ai.title':     'AI Ally Ethics',
      'proj.ai.desc':      'Public platform communicating AI ethics, governance, and responsible innovation to a broad audience — translating technical complexity into accessible content.',
    ...
    pt: {
      ...
      'proj.ai.label':     'Ética em IA · Conteúdo',
      'proj.ai.link':      'Instagram ↗',
      'proj.ai.title':     'AI Ally Ethics',
      'proj.ai.desc':      'Plataforma pública de comunicação sobre ética em IA, governança e inovação responsável para um público amplo — traduzindo complexidade técnica em conteúdo acessível.',
    ...
    nl: {
      ...
      'proj.ai.label':     'AI-ethiek · Inhoud',
      'proj.ai.link':      'Instagram ↗',
      'proj.ai.title':     'AI Ally Ethics',
      'proj.ai.desc':      'Openbaar platform voor communicatie over AI-ethiek, governance en verantwoorde innovatie aan een breed publiek — technische complexiteit vertaald naar toegankelijke inhoud.',
